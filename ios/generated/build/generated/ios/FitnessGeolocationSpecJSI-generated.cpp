...
static jsi::Value __hostFunction_NativeFitnessGeolocationCxxSpecJSI_configureLogger(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFitnessGeolocationCxxSpecJSI *>(&turboModule)->configureLogger(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asObject(rt)
  );
}
...
static jsi::Value __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerIsSupported(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFitnessGeolocationCxxSpecJSI *>(&turboModule)->pedometerIsSupported(
    rt
  );
}
static jsi::Value __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerStart(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFitnessGeolocationCxxSpecJSI *>(&turboModule)->pedometerStart(
    rt,
    count <= 0 || args[0].isNull() || args[0].isUndefined() ? std::nullopt : std::make_optional(args[0].asString(rt))
  );
}
static jsi::Value __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerStop(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFitnessGeolocationCxxSpecJSI *>(&turboModule)->pedometerStop(
    rt
  );
}
static jsi::Value __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerGetSnapshot(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFitnessGeolocationCxxSpecJSI *>(&turboModule)->pedometerGetSnapshot(
    rt
  );
}
static jsi::Value __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerQuery(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFitnessGeolocationCxxSpecJSI *>(&turboModule)->pedometerQuery(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asNumber()
  );
}
static jsi::Value __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerOnAppForeground(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFitnessGeolocationCxxSpecJSI *>(&turboModule)->pedometerOnAppForeground(
    rt
  );
  return jsi::Value::undefined();
}
...
NativeFitnessGeolocationCxxSpecJSI::NativeFitnessGeolocationCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["configureLogger"] = MethodMetadata {1, __hostFunction_NativeFitnessGeolocationCxxSpecJSI_configureLogger};
  ...
  methodMap_["pedometerIsSupported"] = MethodMetadata {0, __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerIsSupported};
  methodMap_["pedometerStart"] = MethodMetadata {1, __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerStart};
  methodMap_["pedometerStop"] = MethodMetadata {0, __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerStop};
  methodMap_["pedometerGetSnapshot"] = MethodMetadata {0, __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerGetSnapshot};
  methodMap_["pedometerQuery"] = MethodMetadata {2, __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerQuery};
  methodMap_["pedometerOnAppForeground"] = MethodMetadata {0, __hostFunction_NativeFitnessGeolocationCxxSpecJSI_pedometerOnAppForeground};
}
